...
########### Dataset address:  https://ieee-dataport.org/open-access/heart-disease-dataset-comprehensive  
...
plot.scatter(X,y) 
plot.title('cholesterol vs max heart rate')  
