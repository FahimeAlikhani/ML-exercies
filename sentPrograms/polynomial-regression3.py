...
# the x-axis represents the input data X and y-axis 
# represents ythe true/target values with 1000 
# examples(m) and 1 feature(n)
...
plot.plot(X, y, 'y.')
plot.plot(X, predict(X, w, b, [2]), 'r.')
plot.legend(["Data", "Polynomial predictions"])
plot.xlabel('X - Input')
plot.ylabel('y - target / true')
